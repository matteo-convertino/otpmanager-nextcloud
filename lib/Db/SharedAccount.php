 ...
 * @method void setExpiredAt(int|string|null $expiredAt)
 *
 * @method int|string|null getCreatedAt()
 * @method void setCreatedAt(int|string|null $createdAt)
 *
 * @method int|string|null getUpdatedAt()
 * @method void setUpdatedAt(int|string|null $updatedAt)
 */
